...
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded">Nhà xuất bản</th>
    ...
    <tbody>
        <?php 
                                    $id1 = getIndex('id');
                                    $db= new db();
                                    $sql= $db->query("select * from book where pub_id = '$id1' limit 20 ");
                                    foreach($sql as $v)
                                    {
    	 ...
    	 <tr>
            ...
            <td><?php echo $v['pub_id'] ?></td>
            <td><a href="nxb.php?id=<?php echo $id1; ?>&idsach=<?php echo $v['book_id'];?>&ac=update"><img src="images/user_edit.png" alt="" title="" border="0" /></a></td>
